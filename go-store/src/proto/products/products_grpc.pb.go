...
func (c *productServiceClient) List(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ProductListResponse, error) {
...
func (UnimplementedProductServiceServer) List(context.Context, *Void) (*ProductListResponse, error) {
...
func _ProductService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).List(ctx, req.(*Void))
	}
